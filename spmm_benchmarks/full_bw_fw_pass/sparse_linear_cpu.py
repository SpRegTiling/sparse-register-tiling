...
from spmm_benchmarks.pytorch_profiler.run import torch_profiler
from spmm_benchmarks.utils.test import construct_test_tensors
from spmm_benchmarks.utils.plot import stack_plot, speedup_plot_torch_benchmark, stack_area_plot_torch_profiler
from spmm_benchmarks.full_bw_fw_pass.linear import *
...
profiler_runners = {
    "torch_profiler": {
        ...
        "mkldnn": partial(torch_profiler, profile_mapping=dense),
    },
    "torch_benchmark": {
        "sputnik": torch_benchmark,
        "dense": torch_benchmark,
        "mkldnn": torch_benchmark,
    }
}
...
if __name__ == '__main__':
    ...
    default_args = dict(
        ...
        dense_types=["dense", "mkldnn"],
        sparse_types=[], sparsities=SPARSITIES,
        device="cpu"
    )
