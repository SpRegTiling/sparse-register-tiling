...
//    rowCnt[A->i[i]]++;
//
//  CSR<Scalar> *B = new CSR(A->n,A->m,A->nnz,A->is_pattern);
...
//  CSC<Scalar> *B = new CSC(A->m,A->n,A->nnz,NULLPNTR,NULLPNTR,A->stype);
//  B->pre_alloc = false;
//  B->is_pattern = false;
...
//  CSC<Scalar> *A = new CSC<Scalar>(n, n, 3 * n - 2);
//  A->is_pattern = true;
//  A->stype = -1;
//
//  int ind = 0;
...
//
//template<typename Scalar>
//CSC<Scalar>* tree_to_csc<Scalar>(int n, int *tree){
