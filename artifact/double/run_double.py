...
bash_script = f"/tmp/experiment_scripts/figure_double_{str(args.mtx_range)}_{str(args.threads)}.sh"
...
outfile = f"figure_double_results_{mtx_range_str}__{threads_str}.csv"

run_dlmc_experiments([mkl_sparse + mkl_dense], RESULTS_DIR + outfile, "double", threads)
